...
RESOURCES_FOLDER = "data/resources/labellist/"
module_location = os.path.abspath(__file__)
module_location = os.path.dirname(module_location)

with open("conf/params.json") as f:
    model_params = json.load(f)

property_blacklist = embeddings.load_blacklist("data/resources/labellist/property_blacklist.txt")
property2idx = {}
with open("data/resources/labellist/property2idx.txt") as f:
...
def model_LSTMContext(p, embedding_matrix, max_sent_len, n_out):
    print("Parameters:", p)
